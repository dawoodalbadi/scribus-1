		...
		case 27:
			...
			if (importerFlags & LoadSavePlugin::lfCreateDoc)
			{
				...
				if (docWidth > docHeight)
					...
					m_Doc->setPageOrientation(0);
				m_Doc->setPageSize("Custom");
				m_Doc->changePageProperties(0, 0, 0, 0, docHeight, docWidth, docHeight, docWidth, m_Doc->pageOrientation(), m_Doc->pageSize(), m_Doc->currentPage()->pageNr(), 0, m_Doc->pageBiding());
